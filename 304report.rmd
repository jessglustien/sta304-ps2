...
Our regression model shows that all coefficients except for ever_married had a sufficiently strong p-value to suggest a meaningful relationship between them and the outcome variable. A small p-value 
